...
Every failure inside face-recognition-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`face_recognition_cli.cli._output`,
...
# Exit-code policy. Documented in ``face-recognition-cli learn`` output.
# 0      = success
