...
--------------------------
Every handler raises :class:`face_recognition_cli.cli._errors.CliError` on
failure; ``main()`` catches it via :func:`_dispatch` and routes through
:mod:`face_recognition_cli.cli._output`. Unknown exceptions are wrapped into a
...
from face_recognition_cli.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/face-recognition-cli/issues"
