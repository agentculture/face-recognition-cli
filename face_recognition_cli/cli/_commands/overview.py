"""``face-recognition-cli overview`` — read-only descriptive snapshot of the agent.
...
:mod:`face_recognition_cli.cli._commands.cli`).
...
from face_recognition_cli.cli._commands.whoami import report
