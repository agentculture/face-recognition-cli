...
uv run face-recognition-cli whoami  # identity from culture.yaml
uv run face-recognition-cli learn   # self-teaching prompt (add --json)
...
1. Rename the package `face_recognition_cli/` and the `face-recognition-cli`
