...
type: command
description: >
  face-recognition-cli's CI/CD lane, layered on `devex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in face-recognition-cli, handling
...
# CI/CD — face-recognition-cli edition
