...
description: >
  ...
  defaults queries to this agent's PERSONAL, PRIVATE scope (`--scope face-recognition-cli
...
- `--scope NAME` / `--visibility public|private` — scope isolation (no private
  ...
  (`--scope face-recognition-cli --visibility private`, suffix read from `culture.yaml`),
